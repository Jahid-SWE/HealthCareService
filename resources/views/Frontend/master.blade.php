...
<!-- Mirrored from html.lionode.com/healthcare/hc001/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Jan 2021 07:09:16 GMT -->
<head>
    <!-- =====  BASIC PAGE NEEDS  ===== -->
    <meta charset="utf-8">
...
<div class="wrapper">
    <div id="subscribe-me" class="modal animated fade in" role="dialog" data-keyboard="true" tabindex="-1">
        <div class="newsletter-popup">
            <img class="offer" src="{{ asset('/') }}/Frontend/images/newsbg.jpg" alt="offer">
    ...
    <header id="header">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <ul class="header-top-left">
                            <li class="language dropdown"> <span class="dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="button"> <img src="{{ asset('/') }}/Frontend/images/English-icon.gif" alt="img"> English <span class="caret"></span> </span>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                    <li><a href="#"><img src="{{ asset('/') }}/Frontend/images/English-icon.gif" alt="img"> English</a></li>
                                    <li><a href="#"><img src="{{ asset('/') }}/Frontend/images/French-icon.gif" alt="img"> French</a></li>
                                    <li><a href="#"><img src="{{ asset('/') }}/Frontend/images/German-icon.gif" alt="img"> German</a></li>
                                </ul>
                            </li>
        ...
        <div class="header">
            <div class="container">
                <nav class="navbar">
                    <div class="navbar-header mtb_20"> <a class="navbar-brand" href="index-2.html"> <img alt="HealthCared" src="{{ asset('/') }}/Frontend/images/logo.png"> </a> </div>
                                ...
                                <ul>
                                    <li>
                                        <table class="table table-striped">
                                            <tbody>
                                            <tr>
                                                <td class="text-center"><a href="#"><img src="{{ asset('/') }}/Frontend/images/product/70x84.jpg" alt="iPod Classic" title="iPod Classic"></a></td>
                        ...
                        <ul id="menu" class="nav navbar-nav">
                                        ...
                                        <ul>
                                            <li id="myCarousel" class="carousel slide" data-ride="carousel">
                                                <div class="carousel-inner">
                                                    <div class="item active"> <a href="#"><img src="{{ asset('/') }}/Frontend/images/menu-banner1.jpg" class="img-responsive" alt="Banner1"></a></div>
                                                    <!-- End Item -->
                                                    <div class="item"> <a href="#"><img src="{{ asset('/') }}/Frontend/images/menu-banner2.jpg" class="img-responsive" alt="Banner1"></a></div>
                                                    <!-- End Item -->
                                                    <div class="item"> <a href="#"><img src="{{ asset('/') }}/Frontend/images/menu-banner3.jpg" class="img-responsive" alt="Banner1"></a></div>
                                                    <!-- End Item -->
                                                </div>
                                                <!-- End Carousel Inner -->
                                            </li>
                            ...
                            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Pages </a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li> <a href="{{ asset('/check-out') }}">Checkout</a></li>
                                    <li> <a href="{{ asset('/product-details-page') }}">Product Detail Page</a></li>
                                    <li> <a href="{{ asset('/single-page') }}">Single Post</a></li>
                                </ul>
                            </li>
                ...
                <div class="col-md-3 footer-block">
                    <div class="content_footercms_right">
                        <div class="footer-contact">
                            <div class="footer-logo mb_40"> <a href="index-2.html"> <img src="{{ asset('/') }}/Frontend/images/footer-logo.png" alt="HealthCare"> </a> </div>
                            <ul>
...
<!-- Mirrored from html.lionode.com/healthcare/hc001/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Jan 2021 07:11:14 GMT -->
</html>
